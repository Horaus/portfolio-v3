                ...
                return (
                  ...
                  >
                    <div className="absolute inset-0 pointer-events-none">
                      ...
                      />
                      <div
                        className="absolute inset-x-0 top-0 h-40 bg-cover blur-2xl transition-opacity duration-500"
                        style={{
                          backgroundImage: `url(${block.image})`,
                          backgroundPosition: block.position,
                      ...
                      />
                      <div
                        className="absolute inset-x-0 bottom-0 h-40 bg-cover blur-2xl transition-opacity duration-500"
                        style={{
                          backgroundImage: `url(${block.image})`,
                          backgroundPosition: block.position,
                          opacity: isActive ? 0.34 : 0,
                      ...
                      />
                      <div className={`absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-black/75 to-transparent transition-opacity duration-500 ${isActive ? 'opacity-100' : 'opacity-0'}`} />
                      <div className={`absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-black/75 to-transparent transition-opacity duration-500 ${isActive ? 'opacity-100' : 'opacity-0'}`} />
                      <div className={`absolute inset-0 bg-black/42 transition-opacity duration-500 ${isActive ? 'opacity-100' : 'opacity-0'}`} />
                    </div>
                ...
                return (
                  ...
                  >
                    <div
                      ...
                      style={{ backgroundImage: `url(${block.image})`, backgroundPosition: block.position }}
                    />
                    ...
                    <div className="relative z-10 p-5 flex flex-col justify-end min-h-[220px]">
                      ...
                      <span className={`inline-flex items-center text-xs font-bold uppercase tracking-[0.14em] ${isComingSoon ? 'text-gray-400' : 'text-white'}`}>
                        {isComingSoon
                          ? t('rd.comingSoon')
                          : block.key === 'library'
                            ? t('rd.libraryCta')
                            : t('rd.viewDetail')}
                        {!isComingSoon && <span className="ml-2" aria-hidden="true">-&gt;</span>}
                      </span>
                    </div>
                  </button>
                );
