        ...
        <div className="bg-darkBg min-h-screen pt-24 pb-0 overflow-x-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-start">
              <div className="lg:col-span-3 space-y-6">
                <h2 className="text-lg font-bold uppercase tracking-widest flex items-center gap-3 text-white">
                  <span className="w-6 h-px bg-accent"></span> Vai trò trong hành trình tối ưu hiệu quả
                </h2>
                ...
                <div className="text-gray-400 text-sm leading-relaxed space-y-4 text-justify">
                  ...
                  <p>
                    Mục tiêu ở đây là trả lời ba câu hỏi dễ hiểu: <strong>kênh nào đang hiệu quả</strong>, <strong>khách rơi ở bước nào</strong> và <strong>điều gì cần gửi ngược lại cho Strategy, Visual, Growth và Automation để tối ưu vòng tiếp theo</strong>.
                  </p>
                </div>
                ...
                <ul className="space-y-3 text-sm">
                  <li className="flex gap-4 group">
                    ...
                    <div className="text-gray-400 leading-snug">
                      <strong className="text-white">Performance Measurement:</strong> Theo dõi traffic, lead quality, CPA/CAC và ROAS để biết kênh nào mang lại kết quả tốt nhất.
                    </div>
                  </li>
                  <li className="flex gap-4 group">
                    <div className="mt-1.5 w-1 h-1 rounded-full bg-accent shrink-0 group-hover:scale-150 transition-transform"></div>
                    <div className="text-gray-400 leading-snug">
                      <strong className="text-white">Behavior Insight:</strong> Đọc scroll depth, rage click, drop-off và form friction để tìm đúng điểm nghẽn chuyển đổi trên landing page hoặc website.
                    </div>
                  </li>
                  <li className="flex gap-4 group">
                    <div className="mt-1.5 w-1 h-1 rounded-full bg-accent shrink-0 group-hover:scale-150 transition-transform"></div>
                    <div className="text-gray-400 leading-snug">
                      <strong className="text-white">Decision Loop:</strong> Dùng dữ liệu để chỉnh message, landing page, media mix, CRM sequence và cách sales xử lý lead ở vòng kế tiếp.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="lg:col-span-2 bg-[#111111] p-6 rounded-2xl border border-white/5 relative group hover:border-accent/20 transition-colors">
                ...
                <div className="space-y-3 relative z-10">
                  <div className="bg-white/5 p-3.5 rounded-xl border border-white/5 hover:bg-white/10 transition-colors">
                    ...
                    <p className="text-[11px] text-gray-500 leading-snug">GA4 là lớp đo lường nền tảng cho traffic, conversion events và attribution cơ bản; Microsoft Clarity ưu tiên để xem replay, heatmap, scroll depth và drop-off. Hotjar có thể dùng thêm khi cần survey hoặc feedback UX sâu hơn.</p>
                  </div>
                  ...
                  <div className="bg-white/5 p-3.5 rounded-xl border border-white/5 hover:bg-white/10 transition-colors">
                    ...
                    <p className="text-[11px] text-gray-500 leading-snug">Power BI hoặc Metabase phù hợp hơn cho dashboard điều hành, drill-down và chia sẻ KPI ổn định cho team. Looker Studio vẫn dùng được cho report nhanh, miễn phí, nhưng không phải lựa chọn ưu tiên khi cần trải nghiệm mượt hơn.</p>
                  </div>
                  ...
                  <div className="bg-white/5 p-3.5 rounded-xl border border-white/5 hover:bg-white/10 transition-colors">
                    ...
                    <p className="text-[11px] text-gray-500 leading-snug">VWO hoặc Optimizely phù hợp khi cần chạy A/B test nghiêm túc, kiểm soát variation và đo uplift rõ ràng thay vì chỉ xem số liệu tổng.</p>
                  </div>
                </div>
          ...
          <section className="bg-[#f2f2f2] pt-16 pb-24 px-4 overflow-hidden shadow-inner" id="report-section">
            <div className="text-center mb-12">
              ...
              <p className="text-[10px] text-gray-500 mt-2 uppercase tracking-widest">Đo hiệu quả • Tìm điểm nghẽn • Ra quyết định tối ưu</p>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <A4Page pageNumber={1} totalPages={2}>
                ...
                <div className="my-6 border border-gray-200 p-6 bg-[#f8f9fa] h-56 rounded-lg shadow-inner">
                    ...
                    <p className="text-[7px] text-center text-gray-400 mt-3 uppercase font-bold tracking-widest">Biểu đồ: So sánh lượng truy cập và tỷ lệ chuyển đổi để phát hiện giai đoạn traffic tăng nhưng hiệu suất không tăng tương ứng</p>
                </div>

                <div className="mt-8 p-6 bg-gray-50 border-l-4 border-black">
                    <h4 className="text-sm font-black uppercase mb-3">Phân tích vận hành</h4>
                    ...
                    <div className="grid grid-cols-3 gap-4 text-[10px] mt-4">
                        ...
                        <div>
                            ...
                            <div className="font-black">Audit UX và test form variations</div>
                        </div>
                    </div>
                </div>
              </A4Page>
                 ...
                 <div className="flex flex-col h-full">
                   ...
                   <div className="grid grid-cols-2 gap-8 mb-10">
                      <div className="space-y-4">
                          ...
                          <p className="text-[10px] text-gray-500 italic leading-relaxed">Tỷ lệ quay lại tăng khi khách đã từng nhận chăm sóc sau chuyến đi, ưu đãi tái đặt dịch vụ hoặc liên hệ lại đúng thời điểm trong CRM.</p>
                      </div>
                      <div className="space-y-4">
                          <div className="p-5 border border-gray-200 rounded-xl bg-gray-50 items-center justify-between flex">
                              <div>
                          ...
                          <p className="text-[10px] text-gray-500 italic leading-relaxed">Giá trị vòng đời tăng rõ hơn ở nhóm khách có lịch sử quay lại, mở email chăm sóc và phản hồi tốt với các đề nghị upsell hoặc referral.</p>
                      </div>
                   </div>
                   ...
                   <div className="grid grid-cols-3 gap-4 mb-10 text-[10px]">
                      <div className="border border-gray-200 rounded-xl p-4 bg-gray-50">
                          ...
                          <div className="font-black text-black">Khách cũ có follow-up sau dịch vụ</div>
                      </div>
                      <div className="border border-gray-200 rounded-xl p-4 bg-gray-50">
                      ...
                      <div className="border border-gray-200 rounded-xl p-4 bg-gray-50">
                          ...
                          <div className="font-black text-black">Gửi insight về Growth, Landing và CRM</div>
                      </div>
                   </div>

                   <ReportClosing
                     title="Kết luận vận hành"
                     summary="Từ dữ liệu hiệu suất và hành vi, có thể xác định rõ phần nào nên nhân rộng, phần nào đang làm rơi chuyển đổi và nhóm khách nào đáng giữ lại lâu hơn. Giá trị lớn nhất của analytics không nằm ở dashboard đẹp mà ở việc biến số liệu thành thay đổi cụ thể cho growth, landing page, CRM sequence và cách sales follow-up."
                   />
                 </div>
              </A4Page>
