        ...
        <main className="relative min-h-screen overflow-hidden bg-black pt-28 text-white">
          <div className="pointer-events-none absolute inset-0">
            <div
              ...
              style={{ backgroundImage: 'url(/images/home/rd-bg.png)' }}
            />
          ...
          <section className="relative z-10 mx-auto w-full max-w-7xl px-5 pb-20 md:px-12">
            <motion.div
              ...
              className="max-w-3xl"
            >
              <p className="mb-5 text-[10px] font-bold uppercase tracking-[0.42em] text-[#8EC9DB]">{t('rd.library.kicker')}</p>
              ...
              {projects.map((project, index) => {
                ...
                return (
                  <motion.button
                    ...
                    className="group relative min-h-[260px] overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] p-6 text-left transition-colors hover:border-[#8EC9DB]/45"
                  >
                    <div
                    ...
                    <div className="relative z-10 flex min-h-[212px] flex-col justify-between">
                      <div className="flex items-center justify-between gap-4">
                        <span className="text-[10px] font-bold uppercase tracking-[0.32em] text-[#8EC9DB]">{project.number}</span>
                        <span className={`rounded-full border px-3 py-1 text-[9px] font-bold uppercase tracking-[0.2em] ${
                          isPublished
                            ? 'border-[#8EC9DB]/45 bg-[#8EC9DB]/10 text-[#8EC9DB]'
