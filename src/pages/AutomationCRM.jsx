        ...
        <div className="bg-darkBg min-h-screen pt-24 pb-0 overflow-x-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-start">
              <div className="lg:col-span-3 space-y-6">
                <h2 className="text-lg font-bold uppercase tracking-widest flex items-center gap-3 text-white">
                  <span className="w-6 h-px bg-accent"></span> Vai trò trong hành trình xử lý lead
                </h2>
                
                <div className="text-gray-400 text-sm leading-relaxed space-y-4 text-justify">
                  <p>
                    Sau khi <strong>Strategy</strong> xác định hướng đi, <strong>Visual</strong> tạo asset và landing page, còn <strong>Growth</strong> mang lead về từ quảng cáo hoặc kênh sở hữu, phần Automation & CRM đảm nhiệm bước nhận lead, chuẩn hóa dữ liệu và đưa lead vào đúng luồng xử lý.
                  </p>
                  <p>
                ...
                <div className="p-6 bg-white/5 border border-white/10 rounded-2xl space-y-6">
                    ...
                    <p className="text-[11px] text-gray-500 italic text-center uppercase tracking-widest font-bold">Quy trình: Nhận lead ➔ Chuẩn hóa dữ liệu ➔ Ưu tiên lead ➔ Phân lead ➔ Thông báo sales ➔ Cập nhật CRM</p>
                </div>
                ...
                <ul className="space-y-4 text-sm mt-8">
                  <li className="flex gap-4 group">
                    ...
                    <div className="text-gray-400 leading-snug">
                      <strong className="text-white uppercase tracking-wider block mb-1">Lead Intake:</strong> Gom lead từ Meta Lead Ads, website form, landing page, inbox và referral vào cùng một luồng nhận dữ liệu để không thất lạc nguồn vào.
                    </div>
                  </li>
                  <li className="flex gap-4 group">
                    <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-accent shrink-0 group-hover:scale-150 transition-transform"></div>
                    <div className="text-gray-400 leading-snug">
                      <strong className="text-white uppercase tracking-wider block mb-1">Routing Rules:</strong> Kiểm tra trùng, gắn source, campaign, mức độ quan tâm và ưu tiên lead trước khi giao cho đúng sales hoặc đưa vào luồng nurturing.
                    </div>
                  </li>
                  <li className="flex gap-4 group">
                    <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-accent shrink-0 group-hover:scale-150 transition-transform"></div>
                    <div className="text-gray-400 leading-snug">
                      <strong className="text-white uppercase tracking-wider block mb-1">CRM Hygiene:</strong> Tạo hoặc cập nhật contact, deal, owner, last contact và status trong CRM để toàn đội nhìn cùng một dữ liệu.
                    </div>
                  </li>
                  <li className="flex gap-4 group">
                    <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-accent shrink-0 group-hover:scale-150 transition-transform"></div>
                    <div className="text-gray-400 leading-snug">
                      <strong className="text-white uppercase tracking-wider block mb-1">Response SLA:</strong> Gửi notify qua Telegram, Slack, email hoặc Zalo ngay khi có lead mới và nhắc lại nếu lead quá thời gian phản hồi đã cam kết.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="lg:col-span-2 bg-[#111111] p-6 rounded-2xl border border-white/5 relative group hover:border-accent/20 transition-colors">
                ...
                <div className="space-y-3 relative z-10">
                   <div className="bg-white/5 p-3.5 rounded-xl border border-white/5 hover:bg-white/10 transition-colors">
                    ...
                    <p className="text-[11px] text-gray-500 leading-snug">n8n, Make hoặc Zapier có thể nhận webhook, kiểm tra trùng, route lead, tạo task và đồng bộ hành động theo từng trạng thái.</p>
                  </div>
                  ...
                  <div className="bg-white/5 p-3.5 rounded-xl border border-white/5 hover:bg-white/10 transition-colors">
                    ...
                    <p className="text-[11px] text-gray-500 leading-snug">HubSpot, Airtable, Notion hoặc Google Sheets dùng để lưu source, owner, status, lịch sử chăm sóc và kiểm soát SLA phản hồi.</p>
                  </div>
                </div>
          ...
          <section className="bg-[#f2f2f2] pt-16 pb-24 px-4 overflow-hidden shadow-inner" id="report-section">
            <div className="text-center mb-12">
              ...
              <p className="text-[10px] text-gray-500 mt-2 uppercase tracking-widest">Nhận lead • Phân lead • Cập nhật CRM • Theo dõi SLA</p>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <A4Page pageNumber={1} totalPages={2}>
                ...
                <div className="grid grid-cols-3 gap-4 mb-8 text-[10px]">
                  ...
                  <div className="border border-gray-200 p-4 bg-[#f8f9fa]">
                    ...
                    <div className="text-xl font-black text-black">&lt; 2 phút</div>
                  ...
                  <div className="border border-gray-200 p-4 bg-[#f8f9fa]">
                    ...
                    <div className="text-xl font-black text-black">3 tầng</div>
                   ...
                   <div className="p-8 border-2 border-dashed border-gray-300 rounded-2xl relative">
                      ...
                      <div className="grid grid-cols-2 gap-6">
                         <div className="p-4 bg-gray-50 border border-gray-200 rounded">
                            ...
                            <p className="text-[9px] text-gray-400">Webhook nhận dữ liệu ngay khi khách gửi form để giữ đầy đủ tên, số điện thoại, nguồn và campaign.</p>
                         </div>
                         <div className="p-4 bg-gray-50 border border-gray-200 rounded">
                            <h4 className="font-black text-[10px] uppercase mb-1">Inbox / Referral / Website</h4>
                            <p className="text-[9px] text-gray-400">API hoặc manual entry đẩy lead vào cùng luồng để mọi nguồn đều được ghi nhận thống nhất.</p>
                         </div>
                      </div>
                   </div>
              ...
              <A4Page pageNumber={2} totalPages={2}>
                 <div className="flex flex-col h-full">
                   <h3 className="text-base font-black uppercase mb-6" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>2. CRM Fields, Ownership & Response Rules</h3>
                   <p className="text-xs mb-8 text-justify leading-relaxed">
                      CRM không chỉ để lưu tên khách hàng. Nó phải cho thấy <strong>lead đến từ đâu</strong>, <strong>ai đang xử lý</strong>, <strong>đã liên hệ lần cuối khi nào</strong> và <strong>lead có đang vượt SLA hay không</strong>.
                   </p>
                   ...
                   <table className="w-full text-[10px] border-collapse border border-gray-300 mb-8">
                      ...
                      <tbody>
                          <tr className="bg-red-50/30">
                              ...
                              <td className="border border-gray-300 p-4">System • ngay khi intake</td>
                              <td className="border border-gray-300 p-4">Tạo contact mới hoặc merge với record cũ nếu trùng số điện thoại/email.</td>
                          </tr>
                          <tr className="bg-orange-50/30">
                              ...
                              <td className="border border-gray-300 p-4">Sales Lead / Sales Rep • dưới 5-30 phút</td>
                              <td className="border border-gray-300 p-4">Giao owner theo rule, tạo task đầu tiên và gửi notify đến đúng nhóm phụ trách.</td>
                          </tr>
                          <tr className="bg-blue-50/30">
                              ...
                              <td className="border border-gray-300 p-4">Sales / Automation • theo SLA</td>
                              <td className="border border-gray-300 p-4">Nhắc lại nếu quá SLA, cập nhật trạng thái và đẩy lead sang nurturing nếu chưa đủ điều kiện chốt.</td>
                          </tr>
                      </tbody>
                   </table>
                   ...
                   <div className="grid grid-cols-3 gap-4 mb-8 text-[10px]">
                      ...
                      <div className="border border-gray-200 rounded-xl p-4 bg-gray-50">
                          ...
                          <div className="font-black text-black">Lead mới phải có owner và first action</div>
                      </div>
                      <div className="border border-gray-200 rounded-xl p-4 bg-gray-50">
                          <div className="text-gray-400 uppercase tracking-widest mb-2">Duplicate Handling</div>
                          <div className="font-black text-black">Merge record hoặc gắn lịch sử chăm sóc cũ</div>
                      </div>
                   </div>

                   <ReportClosing
                     title="Kết luận vận hành"
                     summary="Một luồng automation tốt không chỉ giúp nhận lead nhanh hơn mà còn giữ dữ liệu sạch, gán đúng owner và buộc mọi bước follow-up được cập nhật trong CRM. Khi lớp vận hành này chạy ổn định, đội Sales phản hồi nhanh hơn, tỷ lệ bỏ sót lead giảm xuống và toàn bộ hệ growth có thể mở rộng mà không tạo thêm hỗn loạn."
                   />
                 </div>
              </A4Page>
